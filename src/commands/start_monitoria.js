...
const command = {
    data: new SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: 'Lógica de Programação', value: 'lp' }, { name: 'Algoritmos e Estruturas de Dados I', value: 'aed i' }, { name: 'Algoritmos e Estruturas de Dados II', value: 'aed ii' }))
